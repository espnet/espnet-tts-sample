...
2. **transformer.v2_GL**: Synthesized speech (Feature generetion:transformer.v2, Waveform synthesis: Griffin-Lim algorithm)
...
| **ground_truth** | **transformer.v2_GL** |  
| --- | --- |  
| <audio controls=""> <source src="../../../data/ljspeech/ground_truth/wav/LJ050-0029.wav"> </audio> | <audio controls=""> <source src="../../../data/ljspeech/transformer.v2/wav_GL/LJ050-0029.wav"> </audio> |  

| **Attention wight** | **Probility** |  
| --- | --- |  
| <img src="../../../data/ljspeech/transformer.v2/att_ws/LJ050-0029_att_ws.png" width="320px"> | <img src="../../../data/ljspeech/transformer.v2/probs/LJ050-0029_prob.png" width="320px"> |  
...
| **ground_truth** | **transformer.v2_GL** |  
| --- | --- |  
| <audio controls=""> <source src="../../../data/ljspeech/ground_truth/wav/LJ050-0030.wav"> </audio> | <audio controls=""> <source src="../../../data/ljspeech/transformer.v2/wav_GL/LJ050-0030.wav"> </audio> |  

| **Attention wight** | **Probility** |  
| --- | --- |  
| <img src="../../../data/ljspeech/transformer.v2/att_ws/LJ050-0030_att_ws.png" width="320px"> | <img src="../../../data/ljspeech/transformer.v2/probs/LJ050-0030_prob.png" width="320px"> |  
...
| **ground_truth** | **transformer.v2_GL** |  
| --- | --- |  
| <audio controls=""> <source src="../../../data/ljspeech/ground_truth/wav/LJ050-0031.wav"> </audio> | <audio controls=""> <source src="../../../data/ljspeech/transformer.v2/wav_GL/LJ050-0031.wav"> </audio> |  

| **Attention wight** | **Probility** |  
| --- | --- |  
| <img src="../../../data/ljspeech/transformer.v2/att_ws/LJ050-0031_att_ws.png" width="320px"> | <img src="../../../data/ljspeech/transformer.v2/probs/LJ050-0031_prob.png" width="320px"> |  
...
| **ground_truth** | **transformer.v2_GL** |  
| --- | --- |  
| <audio controls=""> <source src="../../../data/ljspeech/ground_truth/wav/LJ050-0032.wav"> </audio> | <audio controls=""> <source src="../../../data/ljspeech/transformer.v2/wav_GL/LJ050-0032.wav"> </audio> |  

| **Attention wight** | **Probility** |  
| --- | --- |  
| <img src="../../../data/ljspeech/transformer.v2/att_ws/LJ050-0032_att_ws.png" width="320px"> | <img src="../../../data/ljspeech/transformer.v2/probs/LJ050-0032_prob.png" width="320px"> |  
...
| **ground_truth** | **transformer.v2_GL** |  
| --- | --- |  
| <audio controls=""> <source src="../../../data/ljspeech/ground_truth/wav/LJ050-0033.wav"> </audio> | <audio controls=""> <source src="../../../data/ljspeech/transformer.v2/wav_GL/LJ050-0033.wav"> </audio> |  

| **Attention wight** | **Probility** |  
| --- | --- |  
| <img src="../../../data/ljspeech/transformer.v2/att_ws/LJ050-0033_att_ws.png" width="320px"> | <img src="../../../data/ljspeech/transformer.v2/probs/LJ050-0033_prob.png" width="320px"> |  

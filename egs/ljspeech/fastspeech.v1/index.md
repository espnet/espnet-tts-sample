...
2. **Fastspeech.v1-GL**: Synthesized speech (Feature generetion:Fastspeech, Waveform synthesis: Griffin-Lim algorithm)  
3. **Fastspeech.v1-WNV**: Synthesized speech (Feature generetion:Fastspeech, Waveform synthesis: WaveNet vocoder)  

### Sample1  

| **Ground truth** | **Fastspeech.v1-GL** | **Fastspeech.v1-WNV** |  
| --- | --- | --- |  
